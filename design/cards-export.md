...
Generated note: source lines, hidden reads, and chain links are lightweight source-pattern review aids, not complete semantic analysis.

## Corpus Summary

- Starting pool eligibility: 11/144 cards have pool weight > 0 in a new game.
- Down choices: 35 cards.
- Dynamic enabled choices: 35 choices across 35 cards.
- Hidden state writes: 88 nonzero choice effects across 76 cards.
- Hidden state reads: 3 source references across 3 cards.
...
| --- | --- | --- | --- | --- | --- |
| Routine placeholders (routine) | 3 | 3 | 0 | 0 | 0 |
| Incidents (incidents) | 4 | 3 | 0 | 0 | 0 |
| Political placeholders (political) | 2 | 0 | 0 | 0 | 0 |
| Chain placeholders (chains) | 2 | 0 | 0 | 0 | 0 |
| Crisis placeholders (crisis) | 4 | 0 | 0 | 0 | 0 |
| Late game placeholders (late-game) | 3 | 0 | 0 | 0 | 1 |
| Enforcement detection (enforcement-detection) | 4 | 1 | 2 | 2 | 5 |
| Enforcement supply chain (enforcement-supply-chain) | 6 | 1 | 0 | 0 | 4 |
| Enforcement costs (enforcement-costs) | 6 | 1 | 1 | 1 | 7 |
| Enforcement friction (enforcement-friction) | 5 | 0 | 2 | 2 | 5 |
| Enforcement integrity (enforcement-integrity) | 4 | 0 | 0 | 0 | 3 |
| Enforcement monitoring (enforcement-monitoring) | 5 | 0 | 4 | 4 | 4 |
| Enforcement AI paradox (enforcement-ai-paradox) | 3 | 0 | 2 | 2 | 2 |
| Intelligence networks (intelligence-networks) | 5 | 0 | 1 | 1 | 4 |
| Weight security (weight-security) | 3 | 0 | 2 | 2 | 3 |
| Data center chain (data-center-chain) | 2 | 0 | 1 | 1 | 1 |
| Rogue lab chain (rogue-lab-chain) | 2 | 1 | 0 | 0 | 2 |
| International coalition (international-coalition) | 6 | 0 | 2 | 2 | 5 |
| International adversarial (international-adversarial) | 3 | 0 | 1 | 1 | 2 |
| Military escalation (military-escalation) | 2 | 0 | 1 | 1 | 2 |
| Research dual-use (research-dual-use) | 4 | 1 | 0 | 0 | 1 |
| Research scaling (research-scaling) | 3 | 0 | 2 | 2 | 2 |
| Research safety progress (research-safety-progress) | 4 | 0 | 1 | 1 | 0 |
| Safety era chain (safety-era-chain) | 2 | 0 | 0 | 0 | 2 |
| Institutional internal (institutional-internal) | 6 | 0 | 1 | 1 | 3 |
| Institutional leadership (institutional-leadership) | 6 | 0 | 3 | 3 | 1 |
| Institutional capture (institutional-capture) | 3 | 0 | 0 | 0 | 2 |
| Economic costs (economic-costs) | 7 | 0 | 0 | 0 | 5 |
| Corporate response (corporate-response) | 3 | 0 | 1 | 1 | 0 |
| Innovation suppression (innovation-suppression) | 5 | 0 | 2 | 2 | 2 |
| Political support (political-support) | 4 | 0 | 0 | 0 | 3 |
| Opinion dynamics (opinion-dynamics) | 5 | 0 | 0 | 0 | 3 |
| Opposition legal (opposition-legal) | 4 | 0 | 2 | 2 | 3 |
| Accelerationist opposition (accelerationist-opposition) | 2 | 0 | 1 | 1 | 3 |
| Government political (government-political) | 4 | 0 | 1 | 1 | 3 |
| Sub-ASI harms (sub-asi-harms) | 4 | 0 | 1 | 1 | 4 |
| Algorithmic threat (algorithmic-threat) | 3 | 0 | 0 | 0 | 1 |
| Win condition (win-condition) | 1 | 0 | 1 | 1 | 0 |
...
| compute-monitoring | 21 |
| alignment-research | 20 |
| institutional-integrity | 19 |
| rogue-actors | 19 |
| treaty-compliance | 19 |
| international-diplomacy | 17 |
| dual-use-research | 15 |
| media-narrative | 15 |
| economic-pressure | 13 |
| intelligence-agencies | 13 |
| chip-supply-chain | 11 |
| algorithmic-progress | 9 |
| civil-liberties | 9 |
| corporate-lobbying | 6 |
...
| Enforcement Chief | 14 |
| Political Advisor | 13 |
| Diplomatic Attaché | 9 |
...
### Dynamic Enabled Choices

| Card | Choice | Source |
| --- | --- | --- |
| power-grid-anomaly | down | `enforcement-detection.ts:63` |
| datacenter-hidden | down | `enforcement-detection.ts:86` |
| network-bandwidth-trap | down | `enforcement-costs.ts:87` |
| heat-signature-foreign | down | `enforcement-friction.ts:59` |
| challenge-inspection-veto | down | `enforcement-friction.ts:105` |
| decommission-graveyard | down | `enforcement-monitoring.ts:40` |
| surveillance-blind-spot | down | `enforcement-monitoring.ts:86` |
| cloud-provider-loophole | down | `enforcement-monitoring.ts:111` |
| inference-chip-loophole | down | `enforcement-monitoring.ts:136` |
| ai-refuses-order | down | `enforcement-ai-paradox.ts:45` |
| ai-self-improvement | down | `enforcement-ai-paradox.ts:71` |
| secret-capability-market | down | `intelligence-networks.ts:120` |
| weight-theft | down | `weight-security.ts:28` |
| weight-theft-state | down | `weight-security.ts:54` |
| data-center-attack | down | `data-center-chain.ts:19` |
| insincere-member | down | `international-coalition.ts:86` |
| us-china-suspicion | down | `international-coalition.ts:152` |
| war-and-pause | down | `international-adversarial.ts:64` |
| airstrike-debate | down | `military-escalation.ts:16` |
| senior-time-allocation | down | `research-scaling.ts:46` |
| mentoring-pipeline-crisis | down | `research-scaling.ts:71` |
| airgap-large-experiment | down | `research-safety-progress.ts:91` |
| internal-monitoring-expansion | down | `institutional-internal.ts:122` |
| institutional-memory-loss | down | `institutional-leadership.ts:105` |
| rogue-internal-experiment | down | `institutional-leadership.ts:129` |
| funding-deal-techbro | down | `institutional-leadership.ts:154` |
| compliant-defection | down | `corporate-response.ts:24` |
| pharma-ai-breakthrough | down | `innovation-suppression.ts:60` |
| university-consortium-demand | down | `innovation-suppression.ts:124` |
| protest-to-legislator | down | `opposition-legal.ts:31` |
| vote-of-no-confidence | down | `opposition-legal.ts:99` |
| emperor-billionaire | down | `accelerationist-opposition.ts:20` |
| media-waste-story | down | `government-political.ts:92` |
| deepfake-director | down | `sub-asi-harms.ts:52` |
| pivotal-moment | down | `win-condition.ts:12` |

## Routine placeholders (routine)

**budget-review** — *quarterly budget transparency vs operational secrecy*
_Source:_ `routine.ts:9` · _Tags:_ institutional-integrity, political-support · _Pool at new game:_ 2
...
_Source:_ `routine.ts:19` · _Tags:_ corporate-lobbying, compute-monitoring · _Pool at new game:_ 2
...
_Source:_ `routine.ts:29` · _Tags:_ institutional-integrity · _Pool at new game:_ 1.50
...
_Source:_ `incidents.ts:7` · _Tags:_ rogue-actors, compute-monitoring · _Pool at new game:_ 1.50
...
_Source:_ `incidents.ts:26` · _Tags:_ rogue-actors, intelligence-agencies · _Pool at new game:_ 0
...
_Source:_ `incidents.ts:45` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 1.50
...
_Source:_ `incidents.ts:55` · _Tags:_ whistleblowers, rogue-actors · _Pool at new game:_ 1
...
_Source:_ `political.ts:7` · _Tags:_ international-diplomacy, treaty-compliance · _Pool at new game:_ 0
...
_Source:_ `political.ts:20` · _Tags:_ political-support · _Pool at new game:_ 0
...
_Source:_ `chains.ts:7` · _Tags:_ whistleblowers, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `chains.ts:25` · _Tags:_ whistleblowers, media-narrative · _Pool at new game:_ 0
...
_Source:_ `crisis.ts:7` · _Tags:_ political-support, media-narrative · _Pool at new game:_ 0
...
_Source:_ `crisis.ts:21` · _Tags:_ intelligence-agencies · _Pool at new game:_ 0
...
_Source:_ `crisis.ts:35` · _Tags:_ civil-liberties, international-diplomacy · _Pool at new game:_ 0
...
_Source:_ `crisis.ts:49` · _Tags:_ political-support, institutional-integrity · _Pool at new game:_ 0
...
_Source:_ `late-game.ts:8` · _Tags:_ algorithmic-progress, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `late-game.ts:21` · _Tags:_ distributed-compute, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `late-game.ts:34` · _Tags:_ alignment-research, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `enforcement-detection.ts:26` · _Tags:_ compute-monitoring, enforcement-operations · _Pool at new game:_ 1.50
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `enforcement-detection.ts:44` · _Tags:_ compute-monitoring, intelligence-agencies · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility, missed_threats
...
_Source:_ `enforcement-detection.ts:63` · _Tags:_ compute-monitoring, distributed-compute · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `enforcement-detection.ts:86` · _Tags:_ distributed-compute, rogue-actors · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `enforcement-supply-chain.ts:45` · _Tags:_ chip-supply-chain, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `enforcement-supply-chain.ts:65` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `enforcement-supply-chain.ts:85` · _Tags:_ chip-production, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `enforcement-supply-chain.ts:105` · _Tags:_ chip-production, rogue-actors · _Pool at new game:_ 0
...
_Source:_ `enforcement-supply-chain.ts:124` · _Tags:_ algorithmic-progress, compute-monitoring · _Pool at new game:_ 2
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-supply-chain.ts:144` · _Tags:_ algorithmic-progress, distributed-compute · _Pool at new game:_ 0
...
_Source:_ `enforcement-costs.ts:47` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `enforcement-costs.ts:66` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility, missed_threats
...
_Source:_ `enforcement-costs.ts:87` · _Tags:_ compute-monitoring, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-costs.ts:112` · _Tags:_ enforcement-operations, treaty-compliance · _Pool at new game:_ 1.50
_Hidden:_ reads —; writes enforcement_visibility, missed_threats
...
_Source:_ `enforcement-costs.ts:133` · _Tags:_ intelligence-agencies, rogue-actors · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-costs.ts:153` · _Tags:_ rogue-actors, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `enforcement-friction.ts:39` · _Tags:_ enforcement-operations, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-friction.ts:59` · _Tags:_ intelligence-agencies, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads treaty_erosion; writes —
...
_Source:_ `enforcement-friction.ts:83` · _Tags:_ civil-liberties, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure
...
_Source:_ `enforcement-friction.ts:105` · _Tags:_ international-diplomacy, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility, missed_threats
...
_Source:_ `enforcement-friction.ts:132` · _Tags:_ military-ai, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `enforcement-integrity.ts:32` · _Tags:_ chip-supply-chain, institutional-integrity · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-integrity.ts:52` · _Tags:_ institutional-integrity, corporate-lobbying · _Pool at new game:_ 0
...
_Source:_ `enforcement-integrity.ts:71` · _Tags:_ institutional-integrity, compute-monitoring · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-integrity.ts:92` · _Tags:_ civil-liberties, institutional-integrity · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure
...
_Source:_ `enforcement-monitoring.ts:40` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-monitoring.ts:65` · _Tags:_ compute-monitoring, civil-liberties · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure, missed_threats
...
_Source:_ `enforcement-monitoring.ts:86` · _Tags:_ compute-monitoring, rogue-actors · _Pool at new game:_ 0
...
_Source:_ `enforcement-monitoring.ts:111` · _Tags:_ distributed-compute, treaty-compliance · _Pool at new game:_ 0
...
_Source:_ `enforcement-monitoring.ts:136` · _Tags:_ chip-production, compute-monitoring · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-ai-paradox.ts:25` · _Tags:_ compute-monitoring, dual-use-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `enforcement-ai-paradox.ts:45` · _Tags:_ compute-monitoring, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure
...
_Source:_ `enforcement-ai-paradox.ts:71` · _Tags:_ algorithmic-progress, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `intelligence-networks.ts:40` · _Tags:_ chip-supply-chain, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `intelligence-networks.ts:59` · _Tags:_ intelligence-agencies, compute-monitoring · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility, missed_threats
...
_Source:_ `intelligence-networks.ts:80` · _Tags:_ rogue-actors, chip-supply-chain · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `intelligence-networks.ts:100` · _Tags:_ rogue-actors, chip-supply-chain · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `intelligence-networks.ts:120` · _Tags:_ rogue-actors, treaty-compliance · _Pool at new game:_ 0
...
_Source:_ `weight-security.ts:28` · _Tags:_ intelligence-agencies, rogue-actors · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `weight-security.ts:54` · _Tags:_ intelligence-agencies, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `weight-security.ts:80` · _Tags:_ treaty-compliance, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `data-center-chain.ts:19` · _Tags:_ intelligence-agencies, compute-monitoring · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `data-center-chain.ts:44` · _Tags:_ intelligence-agencies, algorithmic-progress · _Pool at new game:_ 0
...
_Source:_ `rogue-lab-chain.ts:18` · _Tags:_ whistleblowers, rogue-actors · _Pool at new game:_ 2
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `rogue-lab-chain.ts:35` · _Tags:_ rogue-actors, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `international-coalition.ts:46` · _Tags:_ international-diplomacy, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `international-coalition.ts:66` · _Tags:_ international-diplomacy, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `international-coalition.ts:86` · _Tags:_ rogue-actors, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility, treaty_erosion
...
_Source:_ `international-coalition.ts:113` · _Tags:_ international-diplomacy, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `international-coalition.ts:133` · _Tags:_ international-diplomacy, rogue-actors · _Pool at new game:_ 0
...
_Source:_ `international-coalition.ts:152` · _Tags:_ international-diplomacy, intelligence-agencies · _Pool at new game:_ 0
...
_Source:_ `international-adversarial.ts:26` · _Tags:_ international-diplomacy, institutional-integrity · _Pool at new game:_ 0
...
_Source:_ `international-adversarial.ts:45` · _Tags:_ chip-supply-chain, international-diplomacy · _Pool at new game:_ 0
...
_Source:_ `international-adversarial.ts:64` · _Tags:_ international-diplomacy, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats, treaty_erosion
...
_Source:_ `military-escalation.ts:16` · _Tags:_ military-ai, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `military-escalation.ts:45` · _Tags:_ military-ai, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `research-dual-use.ts:37` · _Tags:_ dual-use-research, alignment-research · _Pool at new game:_ 0
...
_Source:_ `research-dual-use.ts:56` · _Tags:_ dual-use-research, alignment-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `research-dual-use.ts:83` · _Tags:_ dual-use-research, algorithmic-progress · _Pool at new game:_ 2
...
_Source:_ `research-dual-use.ts:103` · _Tags:_ dual-use-research, alignment-research · _Pool at new game:_ 0
...
_Source:_ `research-scaling.ts:26` · _Tags:_ alignment-research · _Pool at new game:_ 0
...
_Source:_ `research-scaling.ts:46` · _Tags:_ alignment-research, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes mentoring_cut
...
_Source:_ `research-scaling.ts:71` · _Tags:_ alignment-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes mentoring_cut
...
_Source:_ `research-safety-progress.ts:33` · _Tags:_ alignment-research · _Pool at new game:_ 0
...
_Source:_ `research-safety-progress.ts:53` · _Tags:_ alignment-research, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `research-safety-progress.ts:72` · _Tags:_ alignment-research, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `research-safety-progress.ts:91` · _Tags:_ alignment-research, compute-monitoring · _Pool at new game:_ 0
...
_Source:_ `safety-era-chain.ts:19` · _Tags:_ alignment-research, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `safety-era-chain.ts:42` · _Tags:_ treaty-compliance, rogue-actors · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `institutional-internal.ts:44` · _Tags:_ institutional-integrity, civil-liberties · _Pool at new game:_ 0
...
_Source:_ `institutional-internal.ts:63` · _Tags:_ institutional-integrity, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `institutional-internal.ts:82` · _Tags:_ institutional-integrity, intelligence-agencies · _Pool at new game:_ 0
...
_Source:_ `institutional-internal.ts:101` · _Tags:_ whistleblowers, civil-liberties · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure
...
_Source:_ `institutional-internal.ts:122` · _Tags:_ alignment-research, institutional-integrity · _Pool at new game:_ 0
...
_Source:_ `institutional-internal.ts:146` · _Tags:_ compute-monitoring, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes missed_threats
...
_Source:_ `institutional-leadership.ts:47` · _Tags:_ institutional-integrity, political-support · _Pool at new game:_ 0
...
_Source:_ `institutional-leadership.ts:66` · _Tags:_ institutional-integrity, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `institutional-leadership.ts:86` · _Tags:_ institutional-integrity, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `institutional-leadership.ts:105` · _Tags:_ institutional-integrity, intelligence-agencies · _Pool at new game:_ 0
...
_Source:_ `institutional-leadership.ts:129` · _Tags:_ institutional-integrity, alignment-research · _Pool at new game:_ 0
...
_Source:_ `institutional-leadership.ts:154` · _Tags:_ institutional-integrity, economic-pressure · _Pool at new game:_ 0
...
_Source:_ `institutional-capture.ts:26` · _Tags:_ corporate-lobbying, political-support · _Pool at new game:_ 0
...
_Source:_ `institutional-capture.ts:45` · _Tags:_ corporate-lobbying, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `institutional-capture.ts:65` · _Tags:_ corporate-lobbying, rogue-actors · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `economic-costs.ts:53` · _Tags:_ economic-pressure, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `economic-costs.ts:73` · _Tags:_ economic-pressure, treaty-compliance · _Pool at new game:_ 0
...
_Source:_ `economic-costs.ts:92` · _Tags:_ economic-pressure, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage, treaty_erosion
...
_Source:_ `economic-costs.ts:113` · _Tags:_ economic-pressure, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `economic-costs.ts:133` · _Tags:_ economic-pressure, compute-monitoring · _Pool at new game:_ 0
...
_Source:_ `economic-costs.ts:152` · _Tags:_ economic-pressure, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes politicization
...
_Source:_ `economic-costs.ts:172` · _Tags:_ economic-pressure, sub-asi-incidents · _Pool at new game:_ 0
...
_Source:_ `corporate-response.ts:24` · _Tags:_ economic-pressure, treaty-compliance · _Pool at new game:_ 0
...
_Source:_ `corporate-response.ts:49` · _Tags:_ corporate-lobbying, compute-monitoring · _Pool at new game:_ 0
...
_Source:_ `corporate-response.ts:68` · _Tags:_ economic-pressure, dual-use-research · _Pool at new game:_ 0
...
_Source:_ `innovation-suppression.ts:40` · _Tags:_ economic-pressure, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `innovation-suppression.ts:60` · _Tags:_ economic-pressure, dual-use-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes treaty_erosion
...
_Source:_ `innovation-suppression.ts:86` · _Tags:_ alignment-research, economic-pressure · _Pool at new game:_ 0
...
_Source:_ `innovation-suppression.ts:105` · _Tags:_ dual-use-research, civil-liberties · _Pool at new game:_ 0
...
_Source:_ `innovation-suppression.ts:124` · _Tags:_ dual-use-research, alignment-research · _Pool at new game:_ 0
...
_Source:_ `political-support.ts:31` · _Tags:_ political-support, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes politicization
...
_Source:_ `political-support.ts:53` · _Tags:_ political-support, treaty-compliance · _Pool at new game:_ 0
_Hidden:_ reads —; writes politicization
...
_Source:_ `political-support.ts:74` · _Tags:_ political-support, media-narrative · _Pool at new game:_ 0
...
_Source:_ `political-support.ts:94` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `opinion-dynamics.ts:40` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `opinion-dynamics.ts:60` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes politicization
...
_Source:_ `opinion-dynamics.ts:80` · _Tags:_ dual-use-research, media-narrative · _Pool at new game:_ 0
...
_Source:_ `opinion-dynamics.ts:99` · _Tags:_ political-support, media-narrative · _Pool at new game:_ 0
...
_Source:_ `opinion-dynamics.ts:118` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `opposition-legal.ts:31` · _Tags:_ civil-liberties, political-support · _Pool at new game:_ 0
_Hidden:_ reads civil_liberties_pressure; writes civil_liberties_pressure
...
_Source:_ `opposition-legal.ts:57` · _Tags:_ sub-asi-incidents, media-narrative · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `opposition-legal.ts:77` · _Tags:_ civil-liberties, compute-monitoring · _Pool at new game:_ 0
_Hidden:_ reads —; writes civil_liberties_pressure
...
_Source:_ `opposition-legal.ts:99` · _Tags:_ political-support, institutional-integrity · _Pool at new game:_ 0
...
_Source:_ `accelerationist-opposition.ts:20` · _Tags:_ rogue-actors, enforcement-operations · _Pool at new game:_ 0
_Hidden:_ reads —; writes enforcement_visibility
...
_Source:_ `accelerationist-opposition.ts:46` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `government-political.ts:33` · _Tags:_ political-support, alignment-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `government-political.ts:53` · _Tags:_ military-ai, alignment-research · _Pool at new game:_ 0
_Hidden:_ reads —; writes military_dependency
...
_Source:_ `government-political.ts:73` · _Tags:_ alignment-research, enforcement-operations · _Pool at new game:_ 0
...
_Source:_ `government-political.ts:92` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `sub-asi-harms.ts:33` · _Tags:_ sub-asi-incidents, media-narrative · _Pool at new game:_ 0
...
_Source:_ `sub-asi-harms.ts:52` · _Tags:_ sub-asi-incidents, media-narrative · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `sub-asi-harms.ts:78` · _Tags:_ sub-asi-incidents, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `sub-asi-harms.ts:98` · _Tags:_ media-narrative, political-support · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `algorithmic-threat.ts:28` · _Tags:_ algorithmic-progress, compute-monitoring · _Pool at new game:_ 0
...
_Source:_ `algorithmic-threat.ts:47` · _Tags:_ sub-asi-incidents, algorithmic-progress · _Pool at new game:_ 0
_Hidden:_ reads —; writes narrative_damage
...
_Source:_ `algorithmic-threat.ts:67` · _Tags:_ algorithmic-progress, distributed-compute · _Pool at new game:_ 0
...
_Source:_ `win-condition.ts:12` · _Tags:_ alignment-research, international-diplomacy · _Pool at new game:_ 0
_Hidden:_ reads treaty_erosion; writes —
