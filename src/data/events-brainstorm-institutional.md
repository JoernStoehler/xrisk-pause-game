...
These events complement the existing events in `events-draft-v2.md`. No duplication with existing events (#inst--mole-corp, #inst--true-believer, #inst--leadership-purge, #inst--china-hawk, #ai--false-positive-cascade, #ai--surveillance-recommendation, #research--agency-trains-ai, #research--ai-assistant-incident).

---

#### #inst--budget-turf-war
**Type:** crisis
...
**Refs:** → #research--stepping-on-toes (safety might plateau anyway), → #mon--consumer-hw-threshold (enforcement may be losing regardless)
**Bars:** int ↓ if safety funded, saf ↓ if enforcement funded, pol ↓↓ if supplemental attempted

---

#### #inst--vote-of-no-confidence
**Type:** crisis
...
**Refs:** → #inst--leadership-purge (similar but from national government; this is from treaty council), → #pol--corp-lobbying (corporate influence chain)
**Bars:** pol ↓↓ (either way — fight costs capital, resignation costs authority)

---

#### #inst--mission-drift-decade
**Type:** report
**Entities:** isia-enforcement, isia-political, isia-comms
...
**Refs:** → #pol--success-trap (the quiet years that enabled this drift), → #inst--budget-turf-war (the resource allocation that could have prevented it)
...
**Type:** crisis
**Entities:** rogue-insider, journalist, isia-internal-sec
...
**Refs:** → #inst--true-believer (similar internal conflict pattern), → #ai--false-positive-cascade (AI behavior nobody ordered)
...
**Type:** consequence
**Entities:** isia-enforcement, isia-intel, isia-safety-team
...
**Refs:** → #era--generational-shift (external generational dynamics), → #inst--mission-drift-decade (another form of slow degradation)
...
**Refs:** → #inst--china-hawk (similar individual-undermines-institution pattern), → #ai--surveillance-recommendation (the unreliable AI she cited)
...
**Type:** crisis
**Entities:** isia-ai-tools, isia-enforcement, isia-intel
...
#### #inst--morale-crisis
**Type:** crisis
**Entities:** isia-enforcement, isia-safety-team, isia-internal-sec
...
**Refs:** → #isia--institutional-memory-loss (where staff turnover leads), → #pol--success-narrative (the external narrative that corrodes internal morale)
...
**Refs:** → #inst--budget-turf-war (the resource competition this creates), → #inst--mission-drift-decade (another form of institutional dysfunction)
...
**Type:** consequence
**Entities:** isia-ai-tools, rogue-insider, isia-internal-sec
...
**Refs:** → #inst--mole-corp (corporate mole pattern), → #isia--ai-surveillance-blind-spot (AI blind spots, this time deliberate)
