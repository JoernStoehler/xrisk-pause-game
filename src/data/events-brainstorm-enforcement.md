...
#### #enforcement--inference-chip-loophole
**Type:** report
**Entities:** chip-fabricator, isia-enforcement, isia-safety-team
...
**Refs:** → #monitoring--consumer-hw-threshold (same underlying problem: monitoring designed for one compute form factor fails as hardware diversifies)
**Bars:** int ↓ if blind spot accepted, pol ↓ if industry fights expanded monitoring

---

#### #enforcement--billionaire-island-raid
**Type:** crisis
**Entities:** isia-enforcement, rogue-billionaire, interpol, national-enforcement
...
**Refs:** → #monitoring--near-miss (if raid finds active training), → #treaty--diplo-incident (sovereignty fallout)
**Bars:** pol ↓↓ if unilateral action, int ↓ if reveals methods, pol ↑ if legal route succeeds (but only eventually)

---

#### #enforcement--cops-refuse-gpu-search
**Type:** crisis
**Entities:** national-enforcement, isia-enforcement, public-cluster-liberty
...
**Refs:** → #institutional--zealous-officer (parallel domestic enforcement friction), → #monitoring--surveillance-expand (surveillance expansion triggers exactly this backlash)
**Bars:** pol ↓ if FBI escalation, int ↓ if delay lets clusters relocate

---

#### #enforcement--decommission-graveyard
**Type:** report
**Entities:** isia-enforcement, gov-treaty-minor, chip-fabricator
...
**Refs:** → #monitoring--black-market-signal (black market as detection layer), → #monitoring--smuggle-ring (where diverted chips might end up)
**Bars:** int ↓ if chips unaccounted for, pol ↓ if audit angers allies

---

#### #enforcement--power-grid-anomaly
**Type:** report
**Entities:** isia-intelligence, isia-enforcement, national-enforcement
**Topics:** #chip-monitoring, #signals-intelligence, #training-run
...
**Refs:** → #monitoring--heat-signature-foreign (similar detection-then-dilemma pattern), → #intelligence--contradictory-briefs (ambiguous intelligence requiring judgment)
**Bars:** int ↓ if method burned on inspection, int ↑ if passive monitoring yields intel

---

#### #enforcement--network-bandwidth-trap
**Type:** crisis
**Entities:** isia-intelligence, isia-ai-tools, rogue-lab
**Topics:** #chip-monitoring, #signals-intelligence, #false-positive, #training-run
...
**Refs:** → #ai--false-positive-batch (AI monitoring going wrong), → #monitoring--smuggle-ring (distributed evasion pattern)
**Bars:** pol ↓↓ if raids find film studio, int ↓ if delay lets real violator escape

---

#### #enforcement--cat-mouse-adapt
**Type:** consequence
...
**Refs:** → #monitoring--smuggle-ring (the raid that triggered this adaptation), → #monitoring--black-market-signal (market intelligence as alternative to physical tracking)
**Bars:** int ↓ (current methods degraded), pol ↑ if public sees enforcement action

---

#### #enforcement--politically-inconvenient-true-positive
**Type:** crisis
...
**Refs:** → #national-intelligence--jurisdiction-clash (jurisdiction friction with allies), → #treaty--five-year-review (exemptions weaken future enforcement)
**Bars:** pol ↓↓ if US withdraws, int ↓ if classified exemption hides compute from monitoring

---

#### #enforcement--old-chips-new-tricks
**Type:** report
...
**Refs:** → #monitoring--consumer-hw-threshold (the earlier warning about consumer hardware), → #era--threshold-crisis (the endgame version of this problem)
**Bars:** int ↓↓ (massive new blind spot), pol ↓ if treaty amendment attempted

---

#### #enforcement--datacenter-inside-datacenter
**Type:** crisis
...
**Refs:** → #enforcement--inference-chip-loophole (similar theme: monitoring assumptions don't match reality), → #monitoring--near-miss (if the training run was close to producing something dangerous)
**Bars:** int ↑ if side channel analyzed, pol ↓ if public raid harms industry

---

#### #enforcement--custom-asic-foundry
**Type:** report
**Entities:** isia-intelligence, chip-fabricator, rogue-state
...
**Refs:** → #monitoring--asml-joint-venture (chokepoint erosion from the corporate side), → #international--covert-program (the nation's broader strategy)
**Bars:** int ↓↓ (massive new threat vector), pol ↓ if treaty renegotiation fails

---

#### #enforcement--disposal-officer-bribery
**Type:** crisis
**Entities:** isia-enforcement, isia-internal-security, smuggler
**Topics:** #chip-monitoring, #chip-supply, #black-market
...
**Refs:** → #enforcement--decommission-graveyard (the systemic version of this problem), → #institutional--mole (internal corruption pattern)
