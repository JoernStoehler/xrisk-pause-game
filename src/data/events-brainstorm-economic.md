...
#### #econ--cloud-provider-loophole
**Type:** crisis
**Entities:** cloud-provider, isia-enforcement, corp-lobby
...
**Refs:** → #pol--econ-boom-request (similar pressure from above), → #mon--consumer-hw-threshold (monitoring thresholds becoming obsolete)
**Bars:** int ↓ (monitoring suddenly inadequate), pol ↓ if emergency order (legal fight), alg ↑ (distributed runs produce results)

---

#### #corp--nvidia-threshold-lobby
**Type:** crisis
**Entities:** chip-design, corp-lobby, gov-treaty-major, isia-political
...
**Refs:** → #pol--econ-boom-request (G7 version of same pressure), → #mon--consumer-hw-threshold (threshold context)
**Bars:** pol ↓ (political fight is expensive regardless), alg ↑ if threshold raised (more compute available)

---

#### #corp--compliant-company-raid
**Type:** crisis
**Entities:** corp-compliant, isia-enforcement, corp-lobby, journalist
...
**Refs:** → #ai--false-positive-cascade (same monitoring system), → #inst--mole-corp (different kind of agency-industry corruption)
**Bars:** pol ↓ (lose industry cooperation or lose enforcement credibility), int ↓ (voluntary intelligence sharing dries up)

---

#### #econ--pharma-ai-breakthrough
**Type:** crisis
**Entities:** corp-compliant, who, isia-research-ctrl, public-cluster-econ
...
**Refs:** → #pol--medical-ai-request (WHO version, less politically charged), → #pol--econ-boom-request (the commercial version)
**Bars:** pol ↓↓ if denied (massive public backlash), alg ↑ if approved (run may produce capability side effects)

---

#### #corp--hypocrisy-exposed
**Type:** consequence
**Entities:** corp-lobby, ai-company, journalist, isia-intel
...
**Options:**
- Left: Prosecute Nexus aggressively — seize the subsidiary, criminal referrals for the CEO, classify the research (sends a message, but loses the safety insight and hands corp-lobby a martyr: "they destroyed a company for trying to cure alignment")
...
**Refs:** → #pol--corp-lobbying (earlier version of same dynamic), → #research--training-run-consequence (dual-use results from authorized research)
...
**Type:** crisis
**Entities:** chip-fab, gov-treaty-major, isia-political, corp-lobby
...
**Refs:** → #mon--asml-joint-venture (similar chokepoint erosion), → #intl--taiwan-crisis (Taiwan-related supply chain risk)
...
#### #econ--ai-gdp-dependency
**Type:** report
**Entities:** isia-political, corp-compliant, cloud-provider
...
**Refs:** → #pol--ai-economy-report (earlier version), → #pol--unemployment-crisis (social consequences)
**Bars:** (shifts understanding — the economic constraint is now structural, not political)

---

#### #corp--acquisition-consolidation
**Type:** crisis
**Entities:** ai-company, corp-compliant, corp-lobby, isia-enforcement
...
**Refs:** → #inst--mole-corp (company-agency corruption), → #corp--compliant-company-raid (agency-industry relationship)
**Bars:** pol ↓ if blocked (fight with $4.2T company), int ↑ if approved with conditions (better access, but dependency)

---

#### #econ--non-treaty-advantage
**Type:** report
**Entities:** gov-non-treaty, gov-treaty-minor, corp-lobby, public-cluster-econ
...
**Refs:** → #treaty--withdrawal-threat (withdrawal pressure), → #pol--unemployment-crisis (domestic consequences)
**Bars:** pol ↓ (political support for pause erodes)

---

#### #corp--secret-capability-market
**Type:** crisis
**Entities:** ai-company, corp-lobby, isia-intel, isia-enforcement
...
**Refs:** → #econ--cloud-provider-loophole (similar structural workaround), → #mon--black-market-signal (illegal chip market — this is the legal equivalent)
**Bars:** alg ↑ (combined models are more capable), int ↓ (new attack surface the agency wasn't monitoring)

---

#### #econ--automation-two-speeds
**Type:** consequence
**Entities:** public-cluster-econ, corp-compliant, gov-treaty-major, isia-political
...
**Refs:** → #pol--unemployment-crisis (the job-loss angle), → #pol--medical-ai-request (the constrained-innovation angle)
**Bars:** pol ↓ (economic constituency fractures political support)

---

#### #corp--compliant-defection
**Type:** crisis
**Entities:** corp-compliant, corp-lobby, isia-enforcement, gov-treaty-major
...
**Refs:** → #econ--non-treaty-advantage (the competitive pressure causing this), → #corp--compliant-company-raid (another way compliant companies get burned)
**Bars:** pol ↓ if subsidized (expensive), int ↓ if compliance ecosystem collapses (lose voluntary cooperation and monitoring access)

---

#### #econ--algorithmic-trading-incident
**Type:** crisis
...
**Refs:** → #pol--protest-that-helps (non-ASI incident creating political dynamics), → #econ--ai-gdp-dependency (economic integration makes these incidents inevitable)
